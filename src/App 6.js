...
const PUZZLES = [
  ...
  },
  {
    ...
    players: ["MICHAEL IRVIN","WARREN SAPP","CLINTON PORTIS","ANDRE JOHNSON","NDAMUKONG SUH","AHMAN GREEN","PRINCE AMUKAMARA","GRANT WISTROM","GEORGE KITTLE","T.J. HOCKENSON","DALLAS CLARK","BRANDON SCHERFF","CHUCK HOWLEY","RICHARD DENT","DEXTER JACKSON","VON MILLER"],
    groups: [
      { id:"A", players:["MICHAEL IRVIN","WARREN SAPP","CLINTON PORTIS","ANDRE JOHNSON"], label:"PLAYED COLLEGE FOOTBALL AT MIAMI (FL)", color:"#B8860B", difficulty:1 },
      { id:"B", players:["NDAMUKONG SUH","AHMAN GREEN","PRINCE AMUKAMARA","GRANT WISTROM"], label:"PLAYED COLLEGE FOOTBALL AT NEBRASKA", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["GEORGE KITTLE","T.J. HOCKENSON","DALLAS CLARK","BRANDON SCHERFF"], label:"PLAYED COLLEGE FOOTBALL AT IOWA", color:"#1B4F8A", difficulty:3 },
  ...
  },
  {
    ...
    players: ["EMMITT SMITH","TIM TEBOW","PERCY HARVIN","FRED TAYLOR","JEREMY MACLIN","SHELDON RICHARDSON","MICHAEL SAM","CHASE DANIEL","CALVIN JOHNSON","HERMAN MOORE","GOLDEN TATE","MARVIN JONES JR.","CAM NEWTON","JAKE LOCKER","BLAINE GABBERT","CHRISTIAN PONDER"],
    groups: [
      { id:"A", players:["EMMITT SMITH","TIM TEBOW","PERCY HARVIN","FRED TAYLOR"], label:"PLAYED COLLEGE FOOTBALL AT FLORIDA", color:"#B8860B", difficulty:1 },
      { id:"B", players:["JEREMY MACLIN","SHELDON RICHARDSON","MICHAEL SAM","CHASE DANIEL"], label:"PLAYED COLLEGE FOOTBALL AT MISSOURI", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    players: ["TIM COUCH","RANDALL COBB","BUD DUPREE","DERMONTTI DAWSON","LaDAINIAN TOMLINSON","ANDY DALTON","BOB LILLY","JEREMY KERLEY","KEN STABLER","FRED BILETNIKOFF","JACK TATUM","GENE UPSHAW","JIM BROWN","EARL CAMPBELL","EMMITT SMITH","BARRY SANDERS"],
    groups: [
      { id:"A", players:["TIM COUCH","RANDALL COBB","BUD DUPREE","DERMONTTI DAWSON"], label:"PLAYED COLLEGE FOOTBALL AT KENTUCKY", color:"#B8860B", difficulty:1 },
      { id:"B", players:["LaDAINIAN TOMLINSON","ANDY DALTON","BOB LILLY","JEREMY KERLEY"], label:"PLAYED COLLEGE FOOTBALL AT TCU", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    players: ["TONY DUNGY","BOBBY BELL","KEVIN WILLIAMS","MARION BARBER III","DARREN McFADDEN","FELIX JONES","RYAN MALLETT","ALEX COLLINS","ROGER STAUBACH","TONY DORSETT","DREW PEARSON","RANDY WHITE","BOB GRIESE","LARRY CSONKA","PAUL WARFIELD","NICK BUONICONTI"],
    groups: [
      { id:"A", players:["TONY DUNGY","BOBBY BELL","KEVIN WILLIAMS","MARION BARBER III"], label:"PLAYED COLLEGE FOOTBALL AT MINNESOTA", color:"#B8860B", difficulty:1 },
      { id:"B", players:["DARREN McFADDEN","FELIX JONES","RYAN MALLETT","ALEX COLLINS"], label:"PLAYED COLLEGE FOOTBALL AT ARKANSAS", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    players: ["JADEVEON CLOWNEY","STEPHON GILMORE","SIDNEY RICE","MARCUS LATTIMORE","ALEX SMITH","STEVE SMITH SR.","ERIC WEDDLE","PAUL KRUGER","CAM NEWTON","LUKE KUECHLY","GREG OLSEN","JOSH NORMAN","TERRY BRADSHAW","FRANCO HARRIS","JOE GREENE","JACK LAMBERT"],
    groups: [
      { id:"A", players:["JADEVEON CLOWNEY","STEPHON GILMORE","SIDNEY RICE","MARCUS LATTIMORE"], label:"PLAYED COLLEGE FOOTBALL AT SOUTH CAROLINA", color:"#B8860B", difficulty:1 },
  ...
  },
  {
    ...
    players: ["DICK BUTKUS","RED GRANGE","SIMEON RICE","JEFF GEORGE","ROBERT GRIFFIN III","MIKE SINGLETARY","TERRANCE WILLIAMS","KENDALL WRIGHT","BRIAN URLACHER","LANCE BRIGGS","DEVIN HESTER","CHARLES TILLMAN","BART STARR","JIM TAYLOR","PAUL HORNUNG","RAY NITSCHKE"],
    groups: [
      { id:"A", players:["DICK BUTKUS","RED GRANGE","SIMEON RICE","JEFF GEORGE"], label:"PLAYED COLLEGE FOOTBALL AT ILLINOIS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["ROBERT GRIFFIN III","MIKE SINGLETARY","TERRANCE WILLIAMS","KENDALL WRIGHT"], label:"PLAYED COLLEGE FOOTBALL AT BAYLOR", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    players: ["VERNON DAVIS","TORREY SMITH","STEFON DIGGS","E.J. HENDERSON","GENO SMITH","TAVON AUSTIN","BRUCE IRVIN","KEVIN WHITE","RICHARD SHERMAN","EARL THOMAS","KAM CHANCELLOR","BRANDON BROWNER","ELI MANNING","JUSTIN TUCK","OSI UMENYIORA","CHRIS SNEE"],
    groups: [
      { id:"A", players:["VERNON DAVIS","TORREY SMITH","STEFON DIGGS","E.J. HENDERSON"], label:"PLAYED COLLEGE FOOTBALL AT MARYLAND", color:"#B8860B", difficulty:1 },
      { id:"B", players:["GENO SMITH","TAVON AUSTIN","BRUCE IRVIN","KEVIN WHITE"], label:"PLAYED COLLEGE FOOTBALL AT WEST VIRGINIA", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    players: ["PHILIP RIVERS","TORRY HOLT","MARIO WILLIAMS","RUSSELL WILSON","CALVIN JOHNSON","DEMARYIUS THOMAS","KEITH BROOKING","TASHARD CHOICE","PEYTON MANNING","MARVIN HARRISON","REGGIE WAYNE","DWIGHT FREENEY","JOHN ELWAY","TERRELL DAVIS","SHANNON SHARPE","BILL ROMANOWSKI"],
    groups: [
      { id:"A", players:["PHILIP RIVERS","TORRY HOLT","MARIO WILLIAMS","RUSSELL WILSON"], label:"PLAYED COLLEGE FOOTBALL AT NORTH CAROLINA STATE", color:"#B8860B", difficulty:1 },
      { id:"B", players:["CALVIN JOHNSON","DEMARYIUS THOMAS","KEITH BROOKING","TASHARD CHOICE"], label:"PLAYED COLLEGE FOOTBALL AT GEORGIA TECH", color:"#2E6B3E", difficulty:2 },
