...
const PUZZLES = [
  ...
  {
    id: 84, title: "ROUND 84",
    players: ["DeSEAN JACKSON","DeVONTA SMITH","A.J. BROWN","JEREMY MACLIN","PATRICK MAHOMES","ALEX SMITH","JOE MONTANA","TRENT GREEN","ROB GRONKOWSKI","BEN WATSON","HUNTER HENRY","MARTELLUS BENNETT","CALVIN JOHNSON","RANDY MOSS","TIM BROWN","TORRY HOLT"],
    groups: [
      { id:"A", players:["DeSEAN JACKSON","DeVONTA SMITH","A.J. BROWN","JEREMY MACLIN"], label:"PLAYED WIDE RECEIVER FOR THE PHILADELPHIA EAGLES", color:"#B8860B", difficulty:1 },
      { id:"B", players:["PATRICK MAHOMES","ALEX SMITH","JOE MONTANA","TRENT GREEN"], label:"PLAYED QUARTERBACK FOR THE KANSAS CITY CHIEFS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["ROB GRONKOWSKI","BEN WATSON","HUNTER HENRY","MARTELLUS BENNETT"], label:"PLAYED TIGHT END FOR THE NEW ENGLAND PATRIOTS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["CALVIN JOHNSON","RANDY MOSS","TIM BROWN","TORRY HOLT"], label:"WORE NUMBER 81 IN THE NFL", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 85, title: "ROUND 85",
    players: ["FRANCO HARRIS","JEROME BETTIS","LE'VEON BELL","NAJEE HARRIS","DREW BREES","ARCHIE MANNING","DEREK CARR","JAMEIS WINSTON","WARREN MOON","EARL CAMPBELL","BRUCE MATTHEWS","STEVE McNAIR","JIM KELLY","STEVE YOUNG","REGGIE WHITE","HERSCHEL WALKER"],
    groups: [
      { id:"A", players:["FRANCO HARRIS","JEROME BETTIS","LE'VEON BELL","NAJEE HARRIS"], label:"PLAYED RUNNING BACK FOR THE PITTSBURGH STEELERS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["DREW BREES","ARCHIE MANNING","DEREK CARR","JAMEIS WINSTON"], label:"PLAYED QUARTERBACK FOR THE NEW ORLEANS SAINTS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["WARREN MOON","EARL CAMPBELL","BRUCE MATTHEWS","STEVE McNAIR"], label:"PLAYED FOR THE HOUSTON OILERS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["JIM KELLY","STEVE YOUNG","REGGIE WHITE","HERSCHEL WALKER"], label:"PLAYED IN THE USFL BEFORE THE NFL", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 86, title: "ROUND 86",
    players: ["ODELL BECKHAM JR.","PLAXICO BURRESS","VICTOR CRUZ","HAKEEM NICKS","SHAUN ALEXANDER","MARSHAWN LYNCH","KENNETH WALKER III","CURT WARNER","FRAN TARKENTON","DAUNTE CULPEPPER","SAM DARNOLD","J.J. McCARTHY","MORTEN ANDERSEN","SEBASTIAN JANIKOWSKI","JORDAN MAILATA","OSI UMENYIORA"],
    groups: [
      { id:"A", players:["ODELL BECKHAM JR.","PLAXICO BURRESS","VICTOR CRUZ","HAKEEM NICKS"], label:"PLAYED WIDE RECEIVER FOR THE NEW YORK GIANTS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["SHAUN ALEXANDER","MARSHAWN LYNCH","KENNETH WALKER III","CURT WARNER"], label:"PLAYED RUNNING BACK FOR THE SEATTLE SEAHAWKS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["FRAN TARKENTON","DAUNTE CULPEPPER","SAM DARNOLD","J.J. McCARTHY"], label:"PLAYED QUARTERBACK FOR THE MINNESOTA VIKINGS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["MORTEN ANDERSEN","SEBASTIAN JANIKOWSKI","JORDAN MAILATA","OSI UMENYIORA"], label:"BORN OUTSIDE THE UNITED STATES", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 87, title: "ROUND 87",
    players: ["CHAD JOHNSON","A.J. GREEN","JA'MARR CHASE","TEE HIGGINS","LAMAR JACKSON","JOE FLACCO","TRENT DILFER","STEVE McNAIR","TERRELL DAVIS","CLINTON PORTIS","JAVONTE WILLIAMS","FLOYD LITTLE","KYLE JUSZCZYK","MIKE ALSTOTT","LORENZO NEAL","LARRY CSONKA"],
    groups: [
      { id:"A", players:["CHAD JOHNSON","A.J. GREEN","JA'MARR CHASE","TEE HIGGINS"], label:"PLAYED WIDE RECEIVER FOR THE CINCINNATI BENGALS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["LAMAR JACKSON","JOE FLACCO","TRENT DILFER","STEVE McNAIR"], label:"PLAYED QUARTERBACK FOR THE BALTIMORE RAVENS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["TERRELL DAVIS","CLINTON PORTIS","JAVONTE WILLIAMS","FLOYD LITTLE"], label:"PLAYED RUNNING BACK FOR THE DENVER BRONCOS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["KYLE JUSZCZYK","MIKE ALSTOTT","LORENZO NEAL","LARRY CSONKA"], label:"MADE THE PRO BOWL AS A FULLBACK", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 88, title: "ROUND 88",
    players: ["CHRISTIAN McCAFFREY","FRANK GORE","ROGER CRAIG","GARRISON HEARST","MATT RYAN","MICHAEL VICK","MICHAEL PENIX JR.","CHRIS CHANDLER","DICK BUTKUS","MIKE SINGLETARY","BRIAN URLACHER","LANCE BRIGGS","JASON WITTEN","JAY NOVACEK","JAKE FERGUSON","DALTON SCHULTZ"],
    groups: [
      { id:"A", players:["CHRISTIAN McCAFFREY","FRANK GORE","ROGER CRAIG","GARRISON HEARST"], label:"PLAYED RUNNING BACK FOR THE SAN FRANCISCO 49ERS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["MATT RYAN","MICHAEL VICK","MICHAEL PENIX JR.","CHRIS CHANDLER"], label:"PLAYED QUARTERBACK FOR THE ATLANTA FALCONS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["DICK BUTKUS","MIKE SINGLETARY","BRIAN URLACHER","LANCE BRIGGS"], label:"PLAYED LINEBACKER FOR THE CHICAGO BEARS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["JASON WITTEN","JAY NOVACEK","JAKE FERGUSON","DALTON SCHULTZ"], label:"PLAYED TIGHT END FOR THE DALLAS COWBOYS", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 89, title: "ROUND 89",
    players: ["WES WELKER","JULIAN EDELMAN","TROY BROWN","DEION BRANCH","BAKER MAYFIELD","BRAD JOHNSON","VINNY TESTAVERDE","DOUG WILLIAMS","TIKI BARBER","SAQUON BARKLEY","BRANDON JACOBS","AHMAD BRADSHAW","WALTER PAYTON","DEACON JONES","BART STARR","GEORGE HALAS"],
    groups: [
      { id:"A", players:["WES WELKER","JULIAN EDELMAN","TROY BROWN","DEION BRANCH"], label:"PLAYED WIDE RECEIVER FOR THE NEW ENGLAND PATRIOTS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["BAKER MAYFIELD","BRAD JOHNSON","VINNY TESTAVERDE","DOUG WILLIAMS"], label:"PLAYED QUARTERBACK FOR THE TAMPA BAY BUCCANEERS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["TIKI BARBER","SAQUON BARKLEY","BRANDON JACOBS","AHMAD BRADSHAW"], label:"PLAYED RUNNING BACK FOR THE NEW YORK GIANTS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["WALTER PAYTON","DEACON JONES","BART STARR","GEORGE HALAS"], label:"HAS AN NFL AWARD NAMED AFTER THEM", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 90, title: "ROUND 90",
    players: ["KURT WARNER","KYLER MURRAY","CARSON PALMER","JAKE PLUMMER","ISAAC BRUCE","TORRY HOLT","COOPER KUPP","PUKA NACUA","BRIAN WESTBROOK","LeSEAN McCOY","WILBERT MONTGOMERY","DUCE STALEY","ELI MANNING","PHILIP RIVERS","BEN ROETHLISBERGER","J.P. LOSMAN"],
    groups: [
      { id:"A", players:["KURT WARNER","KYLER MURRAY","CARSON PALMER","JAKE PLUMMER"], label:"PLAYED QUARTERBACK FOR THE ARIZONA CARDINALS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["ISAAC BRUCE","TORRY HOLT","COOPER KUPP","PUKA NACUA"], label:"PLAYED WIDE RECEIVER FOR THE RAMS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["BRIAN WESTBROOK","LeSEAN McCOY","WILBERT MONTGOMERY","DUCE STALEY"], label:"PLAYED RUNNING BACK FOR THE PHILADELPHIA EAGLES", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["ELI MANNING","PHILIP RIVERS","BEN ROETHLISBERGER","J.P. LOSMAN"], label:"QUARTERBACKS DRAFTED IN THE FIRST ROUND IN 2004", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 91, title: "ROUND 91",
    players: ["EDGERRIN JAMES","MARSHALL FAULK","JONATHAN TAYLOR","JOSEPH ADDAI","CAM NEWTON","JAKE DELHOMME","TEDDY BRIDGEWATER","KERRY COLLINS","TYREEK HILL","JAYLEN WADDLE","MARK CLAYTON","MARK DUPER","ANTHONY MUNOZ","WALTER JONES","ORLANDO PACE","JOE THOMAS"],
    groups: [
      { id:"A", players:["EDGERRIN JAMES","MARSHALL FAULK","JONATHAN TAYLOR","JOSEPH ADDAI"], label:"PLAYED RUNNING BACK FOR THE INDIANAPOLIS COLTS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["CAM NEWTON","JAKE DELHOMME","TEDDY BRIDGEWATER","KERRY COLLINS"], label:"PLAYED QUARTERBACK FOR THE CAROLINA PANTHERS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["TYREEK HILL","JAYLEN WADDLE","MARK CLAYTON","MARK DUPER"], label:"PLAYED WIDE RECEIVER FOR THE MIAMI DOLPHINS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["ANTHONY MUNOZ","WALTER JONES","ORLANDO PACE","JOE THOMAS"], label:"MADE THE PRO FOOTBALL HALL OF FAME AS AN OFFENSIVE LINEMAN", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 92, title: "ROUND 92",
    players: ["C.J. STROUD","DESHAUN WATSON","MATT SCHAUB","DAVID CARR","FRED TAYLOR","MAURICE JONES-DREW","LEONARD FOURNETTE","TRAVIS ETIENNE","ANDRE REED","ERIC MOULDS","JAMES LOFTON","KHALIL SHAKIR","TERRY BRADSHAW","ROGER STAUBACH","JOE NAMATH","ANDREW LUCK"],
    groups: [
      { id:"A", players:["C.J. STROUD","DESHAUN WATSON","MATT SCHAUB","DAVID CARR"], label:"PLAYED QUARTERBACK FOR THE HOUSTON TEXANS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["FRED TAYLOR","MAURICE JONES-DREW","LEONARD FOURNETTE","TRAVIS ETIENNE"], label:"PLAYED RUNNING BACK FOR THE JACKSONVILLE JAGUARS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["ANDRE REED","ERIC MOULDS","JAMES LOFTON","KHALIL SHAKIR"], label:"PLAYED WIDE RECEIVER FOR THE BUFFALO BILLS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["TERRY BRADSHAW","ROGER STAUBACH","JOE NAMATH","ANDREW LUCK"], label:"WORE NUMBER 12 AS AN NFL QUARTERBACK", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 93, title: "ROUND 93",
    players: ["BRANDON MARSHALL","ALSHON JEFFERY","D.J. MOORE","ROME ODUNZE","AARON JONES","AHMAN GREEN","JOSH JACOBS","EDDIE LACY","MARK ANDREWS","SHANNON SHARPE","TODD HEAP","DENNIS PITTA","BRUCE SMITH","JADEVEON CLOWNEY","MYLES GARRETT","MARIO WILLIAMS"],
    groups: [
      { id:"A", players:["BRANDON MARSHALL","ALSHON JEFFERY","D.J. MOORE","ROME ODUNZE"], label:"PLAYED WIDE RECEIVER FOR THE CHICAGO BEARS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["AARON JONES","AHMAN GREEN","JOSH JACOBS","EDDIE LACY"], label:"PLAYED RUNNING BACK FOR THE GREEN BAY PACKERS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["MARK ANDREWS","SHANNON SHARPE","TODD HEAP","DENNIS PITTA"], label:"PLAYED TIGHT END FOR THE BALTIMORE RAVENS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["BRUCE SMITH","JADEVEON CLOWNEY","MYLES GARRETT","MARIO WILLIAMS"], label:"SELECTED FIRST OVERALL AS A NON-QUARTERBACK", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 94, title: "ROUND 94",
    players: ["GALE SAYERS","MATT FORTE","DAVID MONTGOMERY","D'ANDRE SWIFT","MARK BRUNELL","TREVOR LAWRENCE","BLAKE BORTLES","DAVID GARRARD","LARRY FITZGERALD","ANQUAN BOLDIN","MARVIN HARRISON JR.","DeANDRE HOPKINS","ED REED","TROY POLAMALU","BRIAN DAWKINS","KENNY EASLEY"],
    groups: [
      { id:"A", players:["GALE SAYERS","MATT FORTE","DAVID MONTGOMERY","D'ANDRE SWIFT"], label:"PLAYED RUNNING BACK FOR THE CHICAGO BEARS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["MARK BRUNELL","TREVOR LAWRENCE","BLAKE BORTLES","DAVID GARRARD"], label:"PLAYED QUARTERBACK FOR THE JACKSONVILLE JAGUARS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["LARRY FITZGERALD","ANQUAN BOLDIN","MARVIN HARRISON JR.","DeANDRE HOPKINS"], label:"PLAYED WIDE RECEIVER FOR THE ARIZONA CARDINALS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["ED REED","TROY POLAMALU","BRIAN DAWKINS","KENNY EASLEY"], label:"MADE THE PRO FOOTBALL HALL OF FAME AS A SAFETY", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 95, title: "ROUND 95",
    players: ["KEN STABLER","JIM PLUNKETT","RICH GANNON","DEREK CARR","KEYSHAWN JOHNSON","WAYNE CHREBET","GARRETT WILSON","SANTANA MOSS","BIJAN ROBINSON","MICHAEL TURNER","JAMAL ANDERSON","DEVONTA FREEMAN","JOHN ELWAY","OZZIE NEWSOME","MATT MILLEN","JOHN LYNCH"],
    groups: [
      { id:"A", players:["KEN STABLER","JIM PLUNKETT","RICH GANNON","DEREK CARR"], label:"PLAYED QUARTERBACK FOR THE RAIDERS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["KEYSHAWN JOHNSON","WAYNE CHREBET","GARRETT WILSON","SANTANA MOSS"], label:"PLAYED WIDE RECEIVER FOR THE NEW YORK JETS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["BIJAN ROBINSON","MICHAEL TURNER","JAMAL ANDERSON","DEVONTA FREEMAN"], label:"PLAYED RUNNING BACK FOR THE ATLANTA FALCONS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["JOHN ELWAY","OZZIE NEWSOME","MATT MILLEN","JOHN LYNCH"], label:"RAN AN NFL FRONT OFFICE AFTER THEIR PLAYING CAREER", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 96, title: "ROUND 96",
    players: ["ART MONK","TERRY McLAURIN","GARY CLARK","DeSEAN JACKSON","MARCUS MARIOTA","VINCE YOUNG","WILL LEVIS","CAM WARD","ZACH ERTZ","DALLAS GOEDERT","BRENT CELEK","KEITH JACKSON","DEION SANDERS","CHAMP BAILEY","DARRELL GREEN","TY LAW"],
    groups: [
      { id:"A", players:["ART MONK","TERRY McLAURIN","GARY CLARK","DeSEAN JACKSON"], label:"PLAYED WIDE RECEIVER FOR WASHINGTON", color:"#B8860B", difficulty:1 },
      { id:"B", players:["MARCUS MARIOTA","VINCE YOUNG","WILL LEVIS","CAM WARD"], label:"PLAYED QUARTERBACK FOR THE TENNESSEE TITANS", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["ZACH ERTZ","DALLAS GOEDERT","BRENT CELEK","KEITH JACKSON"], label:"PLAYED TIGHT END FOR THE PHILADELPHIA EAGLES", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["DEION SANDERS","CHAMP BAILEY","DARRELL GREEN","TY LAW"], label:"MADE THE PRO FOOTBALL HALL OF FAME AS A CORNERBACK", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 97, title: "ROUND 97",
    players: ["DWAYNE BOWE","XAVIER WORTHY","RASHEE RICE","TYREEK HILL","RICKY WILLIAMS","RONNIE BROWN","DE'VON ACHANE","LARRY CSONKA","JEREMY SHOCKEY","MARK BAVARO","EVAN ENGRAM","KEVIN BOSS","DEVIN HESTER","DANTE HALL","JOSH CRIBBS","CORDARRELLE PATTERSON"],
    groups: [
      { id:"A", players:["DWAYNE BOWE","XAVIER WORTHY","RASHEE RICE","TYREEK HILL"], label:"PLAYED WIDE RECEIVER FOR THE KANSAS CITY CHIEFS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["RICKY WILLIAMS","RONNIE BROWN","DE'VON ACHANE","LARRY CSONKA"], label:"PLAYED RUNNING BACK FOR THE MIAMI DOLPHINS", color:"#2E6B3E", difficulty:2 },
...
const FEATURED_PUZZLES = [
  ...
  },
  {
    ...
    themeTitle: "WEEK 2 REWIND",
    themeBlurb: "Two weeks in and the headlines are already stacking up. Every name here made one on Sunday, or Thursday.",
    activeFrom: "2026-09-22",
    activeUntil: "2026-09-29",
    title: "FEATURED \u00b7 WEEK 2 REWIND",
    players: [
      "CALEB WILLIAMS","JAYDEN DANIELS","JAYDEN REED","SAUCE GARDNER",
      "JARED GOFF","JAHMYR GIBBS","JAMES COOK","DALTON KINCAID",
      "DAK PRESCOTT","PATRICK MAHOMES","BRYCE YOUNG","KIRK COUSINS",
      "JAXON SMITH-NJIGBA","CeeDEE LAMB","STEFON DIGGS","DARREN WALLER"
    ],
    groups: [
      { id:"A", players:["CALEB WILLIAMS","JAYDEN DANIELS","JAYDEN REED","SAUCE GARDNER"], label:"LEFT THEIR WEEK 2 GAME WITH AN INJURY", color:"#B8860B", difficulty:1 },
      { id:"B", players:["JARED GOFF","JAHMYR GIBBS","JAMES COOK","DALTON KINCAID"], label:"PLAYED IN THE FIRST GAME AT THE BILLS' NEW STADIUM", color:"#2E6B3E", difficulty:2 },
