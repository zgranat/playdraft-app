...
const PUZZLES = [
  {
    id: 1, title: "ROUND 1",
    players: ["TOM BRADY","CHARLES WOODSON","DESMOND HOWARD","JIM HARBAUGH","JOE MONTANA","TERRY BRADSHAW","CHARLES HALEY","MEAN JOE GREENE","JIM PLUNKETT","MARCUS ALLEN","HOWIE LONG","FRED BILETNIKOFF","EDDIE GEORGE","SHAUN ALEXANDER","TROY POLAMALU","DAUNTE CULPEPPER"],
    groups: [
      { id:"A", players:["TOM BRADY","CHARLES WOODSON","DESMOND HOWARD","JIM HARBAUGH"], label:"PLAYED COLLEGE FOOTBALL AT MICHIGAN", color:"#B8860B", difficulty:1 },
  ...
  {
    id: 2, title: "ROUND 2",
    players: ["PEYTON MANNING","ELI MANNING","ARCHIE MANNING","COOPER MANNING","BO JACKSON","DEION SANDERS","RUSSELL WILSON","KYLER MURRAY","JOE HORN","BRANDON MARSHALL","ANTONIO BROWN","RANDY MOSS","DAVID TYREE","SANTONIO HOLMES","LYNN SWANN","JOHN TAYLOR"],
    groups: [
  ...
  {
    id: 6, title: "ROUND 6",
    players: ["REGGIE BUSH","MATT LEINART","CARSON PALMER","ANTHONY MUNOZ","DEVIN HESTER","DEION SANDERS","CORDARRELLE PATTERSON","DESEAN JACKSON","TONY DORSETT","CURTIS MARTIN","LeSEAN McCOY","JAMES CONNER","DOUG WILLIAMS","VINNY TESTAVERDE","TRENT DILFER","JAMEIS WINSTON"],
    groups: [
      { id:"A", players:["REGGIE BUSH","MATT LEINART","CARSON PALMER","ANTHONY MUNOZ"], label:"PLAYED COLLEGE FOOTBALL AT USC", color:"#B8860B", difficulty:1 },
  ...
  {
    id: 8, title: "ROUND 8",
    players: ["TONY GONZALEZ","REGGIE WHITE","PEYTON MANNING","JUNIOR SEAU","JOE MONTANA","JERRY RICE","ROGER CRAIG","CHARLES HALEY","MATT RYAN","PATRICK MAHOMES","JARED GOFF","JAKE DELHOMME","JIM KELLY","HERSCHEL WALKER","DOUG FLUTIE","SAM MILLS"],
    groups: [
      ...
      { id:"D", players:["JIM KELLY","HERSCHEL WALKER","DOUG FLUTIE","SAM MILLS"], label:"PLAYED IN THE USFL BEFORE JOINING THE NFL", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 9, title: "ROUND 9",
  ...
  },
  {
    ...
    players: ["BEN ROETHLISBERGER","HINES WARD","TROY POLAMALU","JAMES HARRISON","JOE BURROW","ODELL BECKHAM JR.","PATRICK PETERSON","JUSTIN JEFFERSON","NICK FOLES","JEFF HOSTETLER","KURT WARNER","JIM PLUNKETT","MARSHALL FAULK","CALVIN JOHNSON","DONOVAN McNABB","MARCUS MARIOTA"],
    groups: [
      ...
      { id:"C", players:["NICK FOLES","JEFF HOSTETLER","KURT WARNER","JIM PLUNKETT"], label:"TOOK OVER AS A BACKUP MIDSEASON AND STARTED IN A SUPER BOWL", color:"#1B4F8A", difficulty:3 },
  ...
  },
  {
    ...
    players: ["ELI MANNING","VICTOR CRUZ","HAKEEM NICKS","JUSTIN TUCK","ROGER STAUBACH","DOUG FLUTIE","AARON RODGERS","RUSSELL WILSON","JOHN ELWAY","ANDREW LUCK","CHRISTIAN McCAFFREY","RICHARD SHERMAN","JOE NAMATH","GEORGE BLANDA","LANCE ALWORTH","DON MAYNARD"],
    groups: [
      { id:"A", players:["ELI MANNING","VICTOR CRUZ","HAKEEM NICKS","JUSTIN TUCK"], label:"PLAYED FOR THE NEW YORK GIANTS SUPER BOWL XLVI TEAM", color:"#B8860B", difficulty:1 },
      { id:"B", players:["ROGER STAUBACH","DOUG FLUTIE","AARON RODGERS","RUSSELL WILSON"], label:"THREW A FAMOUS \"HAIL MARY\" TOUCHDOWN PASS IN THE NFL", color:"#2E6B3E", difficulty:2 },
      ...
      { id:"D", players:["JOE NAMATH","GEORGE BLANDA","LANCE ALWORTH","DON MAYNARD"], label:"PLAYED IN THE AFL BEFORE THE AFL-NFL MERGER OF 1970", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
  ...
  },
  {
    ...
    players: ["WALTER PAYTON","JIM McMAHON","MIKE SINGLETARY","WILLIAM PERRY","CRIS CARTER","EZEKIEL ELLIOTT","EDDIE GEORGE","JOEY BOSA","EARL CAMPBELL","RICKY WILLIAMS","VINCE YOUNG","JAMAAL CHARLES","DREW BREES","NICK FOLES","Y.A. TITTLE","SID LUCKMAN"],
    groups: [
      ...
      { id:"D", players:["SID LUCKMAN","DREW BREES","NICK FOLES","Y.A. TITTLE"], label:"THREW 7 TOUCHDOWN PASSES IN A SINGLE NFL GAME", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 25, title: "ROUND 25",
    players: ["PEYTON MANNING","MARVIN HARRISON","REGGIE WAYNE","DWIGHT FREENEY","STEVE YOUNG","JEFF GARCIA","COLIN KAEPERNICK","BROCK PURDY","WALTER PAYTON","STEVE McNAIR","DOUG WILLIAMS","MEL BLOUNT","OSI UMENYIORA","JASON PIERRE-PAUL","BRANDON GRAHAM","CHRIS LONG"],
    groups: [
      ...
      { id:"C", players:["WALTER PAYTON","STEVE McNAIR","DOUG WILLIAMS","MEL BLOUNT"], label:"PLAYED COLLEGE FOOTBALL AT A HISTORICALLY BLACK COLLEGE OR UNIVERSITY", color:"#1B4F8A", difficulty:3 },
...
const LAUNCH_DATE = new Date(2026, 5, 26);
