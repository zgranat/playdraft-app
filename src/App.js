...
const PUZZLES = [
  ...
  },
  {
    ...
    players: ["PEYTON MANNING","TOM BRADY","AARON RODGERS","LAMAR JACKSON","MICHAEL IRVIN","WARREN SAPP","CLINTON PORTIS","ANDRE JOHNSON","JACK LAMBERT","JAMES HARRISON","T.J. WATT","JOEY PORTER","CHUCK HOWLEY","RICHARD DENT","DEXTER JACKSON","VON MILLER"],
    groups: [
      { id:"A", players:["PEYTON MANNING","TOM BRADY","AARON RODGERS","LAMAR JACKSON"], label:"WON THE NFL MOST VALUABLE PLAYER AWARD", color:"#B8860B", difficulty:1 },
      ...
      { id:"D", players:["CHUCK HOWLEY","RICHARD DENT","DEXTER JACKSON","VON MILLER"], label:"WON SUPER BOWL MVP AS A DEFENSIVE PLAYER", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 63, title: "ROUND 63",
    players: ["BRETT FAVRE","AARON RODGERS","BART STARR","JORDAN LOVE","EMMITT SMITH","TIM TEBOW","PERCY HARVIN","FRED TAYLOR","CALVIN JOHNSON","HERMAN MOORE","GOLDEN TATE","MARVIN JONES JR.","CAM NEWTON","JAKE LOCKER","BLAINE GABBERT","CHRISTIAN PONDER"],
    groups: [
      { id:"A", players:["BRETT FAVRE","AARON RODGERS","BART STARR","JORDAN LOVE"], label:"PLAYED QUARTERBACK FOR THE GREEN BAY PACKERS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["EMMITT SMITH","TIM TEBOW","PERCY HARVIN","FRED TAYLOR"], label:"PLAYED COLLEGE FOOTBALL AT FLORIDA", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["CALVIN JOHNSON","HERMAN MOORE","GOLDEN TATE","MARVIN JONES JR."], label:"PLAYED WIDE RECEIVER FOR THE DETROIT LIONS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["CAM NEWTON","JAKE LOCKER","BLAINE GABBERT","CHRISTIAN PONDER"], label:"QUARTERBACKS DRAFTED IN THE FIRST ROUND IN 2011", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 64, title: "ROUND 64",
    players: ["TOM BRADY","ROB GRONKOWSKI","JULIAN EDELMAN","DEVIN McCOURTY","JERRY HUGHES","ANDY DALTON","BOB LILLY","JEREMY KERLEY","KEN STABLER","FRED BILETNIKOFF","JACK TATUM","GENE UPSHAW","JIM BROWN","EARL CAMPBELL","EMMITT SMITH","BARRY SANDERS"],
    groups: [
      { id:"A", players:["TOM BRADY","ROB GRONKOWSKI","JULIAN EDELMAN","DEVIN McCOURTY"], label:"WON A SUPER BOWL WITH THE NEW ENGLAND PATRIOTS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["JERRY HUGHES","ANDY DALTON","BOB LILLY","JEREMY KERLEY"], label:"PLAYED COLLEGE FOOTBALL AT TCU", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["KEN STABLER","FRED BILETNIKOFF","JACK TATUM","GENE UPSHAW"], label:"PLAYED FOR THE OAKLAND RAIDERS IN THE 1970s", color:"#1B4F8A", difficulty:3 },
  ...
  },
  {
    ...
    players: ["RANDY MOSS","CRIS CARTER","JUSTIN JEFFERSON","ADAM THIELEN","LAWRENCE TAYLOR","RAY LEWIS","J.J. WATT","AARON DONALD","ROGER STAUBACH","TONY DORSETT","DREW PEARSON","RANDY WHITE","BOB GRIESE","LARRY CSONKA","PAUL WARFIELD","NICK BUONICONTI"],
    groups: [
      { id:"A", players:["RANDY MOSS","CRIS CARTER","JUSTIN JEFFERSON","ADAM THIELEN"], label:"PLAYED WIDE RECEIVER FOR THE MINNESOTA VIKINGS", color:"#B8860B", difficulty:1 },
      ...
      { id:"C", players:["ROGER STAUBACH","TONY DORSETT","DREW PEARSON","RANDY WHITE"], label:"PLAYED FOR THE DALLAS COWBOYS IN THE 1970s", color:"#1B4F8A", difficulty:3 },
  ...
  },
  {
    ...
    players: ["JOHN ELWAY","PEYTON MANNING","RUSSELL WILSON","TIM TEBOW","ALEX SMITH","STEVE SMITH SR.","ERIC WEDDLE","PAUL KRUGER","CAM NEWTON","LUKE KUECHLY","GREG OLSEN","JOSH NORMAN","TERRY BRADSHAW","FRANCO HARRIS","JOE GREENE","JACK LAMBERT"],
    groups: [
      ...
      { id:"B", players:["ALEX SMITH","STEVE SMITH SR.","ERIC WEDDLE","PAUL KRUGER"], label:"PLAYED COLLEGE FOOTBALL AT UTAH", color:"#2E6B3E", difficulty:2 },
      ...
      { id:"D", players:["TERRY BRADSHAW","FRANCO HARRIS","JOE GREENE","JACK LAMBERT"], label:"PLAYED FOR THE PITTSBURGH STEELERS DURING THEIR FOUR SUPER BOWLS IN THE 1970s", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 67, title: "ROUND 67",
    players: ["MICHAEL IRVIN","DEZ BRYANT","CeeDee LAMB","TERRELL OWENS","DICK BUTKUS","RED GRANGE","SIMEON RICE","JEFF GEORGE","BRIAN URLACHER","LANCE BRIGGS","DEVIN HESTER","CHARLES TILLMAN","BART STARR","JIM TAYLOR","PAUL HORNUNG","RAY NITSCHKE"],
    groups: [
      ...
      { id:"B", players:["DICK BUTKUS","RED GRANGE","SIMEON RICE","JEFF GEORGE"], label:"PLAYED COLLEGE FOOTBALL AT ILLINOIS", color:"#2E6B3E", difficulty:2 },
      ...
      { id:"D", players:["BART STARR","JIM TAYLOR","PAUL HORNUNG","RAY NITSCHKE"], label:"PLAYED FOR THE GREEN BAY PACKERS DURING THE 1960s VINCE LOMBARDI ERA", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 68, title: "ROUND 68",
    players: ["JIM KELLY","JOSH ALLEN","DOUG FLUTIE","RYAN FITZPATRICK","VERNON DAVIS","TORREY SMITH","STEFON DIGGS","E.J. HENDERSON","RICHARD SHERMAN","EARL THOMAS","KAM CHANCELLOR","BRANDON BROWNER","ELI MANNING","JUSTIN TUCK","OSI UMENYIORA","CHRIS SNEE"],
    groups: [
      { id:"A", players:["JIM KELLY","JOSH ALLEN","DOUG FLUTIE","RYAN FITZPATRICK"], label:"PLAYED QUARTERBACK FOR THE BUFFALO BILLS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["VERNON DAVIS","TORREY SMITH","STEFON DIGGS","E.J. HENDERSON"], label:"PLAYED COLLEGE FOOTBALL AT MARYLAND", color:"#2E6B3E", difficulty:2 },
      ...
      { id:"D", players:["ELI MANNING","JUSTIN TUCK","OSI UMENYIORA","CHRIS SNEE"], label:"PLAYED FOR THE NEW YORK GIANTS ON BOTH THEIR SUPER BOWL XLII AND XLVI WINNING TEAMS", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 69, title: "ROUND 69",
    players: ["HINES WARD","ANTONIO BROWN","JUJU SMITH-SCHUSTER","SANTONIO HOLMES","PHILIP RIVERS","TORRY HOLT","MARIO WILLIAMS","RUSSELL WILSON","PEYTON MANNING","MARVIN HARRISON","REGGIE WAYNE","DWIGHT FREENEY","JOHN ELWAY","TERRELL DAVIS","SHANNON SHARPE","BILL ROMANOWSKI"],
    groups: [
      ...
      { id:"D", players:["JOHN ELWAY","TERRELL DAVIS","SHANNON SHARPE","BILL ROMANOWSKI"], label:"PLAYED FOR THE DENVER BRONCOS ON BACK-TO-BACK SUPER BOWL WINS (XXXII & XXXIII)", color:"#8B1A2A", difficulty:4 }
    ]
  }
];
