...
const PUZZLES = [
  {
    id: 1, title: "ROUND 1",
    players: ["TOM BRADY","CHARLES WOODSON","DESMOND HOWARD","DEVIN HESTER","JOE MONTANA","TERRY BRADSHAW","CHARLES HALEY","MEAN JOE GREENE","JIM PLUNKETT","MARCUS ALLEN","HOWIE LONG","FRED BILETNIKOFF","EDDIE GEORGE","SHAUN ALEXANDER","TROY POLAMALU","DAUNTE CULPEPPER"],
    groups: [
      { id:"A", players:["TOM BRADY","CHARLES WOODSON","DESMOND HOWARD","DEVIN HESTER"], label:"PLAYED COLLEGE FOOTBALL AT MICHIGAN", color:"#B8860B", difficulty:1 },
      { id:"B", players:["JOE MONTANA","TERRY BRADSHAW","CHARLES HALEY","MEAN JOE GREENE"], label:"WON 4+ SUPER BOWLS AS A PLAYER", color:"#1B4F8A", difficulty:3 },
      { id:"C", players:["JIM PLUNKETT","MARCUS ALLEN","HOWIE LONG","FRED BILETNIKOFF"], label:"PLAYED FOR THE OAKLAND RAIDERS SUPER BOWL-WINNING TEAMS", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    groups: [
      ...
      { id:"C", players:["LARRY FITZGERALD","ELI MANNING","RUSSELL WILSON","DAK PRESCOTT"], label:"WON THE WALTER PAYTON NFL MAN OF THE YEAR AWARD", color:"#8B1A2A", difficulty:4 },
      { id:"D", players:["TOM BRADY","TERRELL DAVIS","SHANNON SHARPE","ANTONIO BROWN"], label:"DRAFTED IN THE 6TH ROUND OR LATER, BECAME A PRO BOWL PLAYER", color:"#1B4F8A", difficulty:3 }
    ]
  },
  {
    id: 4, title: "ROUND 4",
  ...
  {
    id: 6, title: "ROUND 6",
    players: ["JOE BURROW","ODELL BECKHAM JR.","PATRICK PETERSON","JUSTIN JEFFERSON","REGGIE BUSH","MATT LEINART","CARSON PALMER","ANTHONY MUNOZ","EARL CAMPBELL","RICKY WILLIAMS","VINCE YOUNG","JAMAAL CHARLES","CRIS CARTER","EZEKIEL ELLIOTT","ORLANDO PACE","JOEY BOSA"],
    groups: [
      { id:"A", players:["JOE BURROW","ODELL BECKHAM JR.","PATRICK PETERSON","JUSTIN JEFFERSON"], label:"PLAYED COLLEGE FOOTBALL AT LSU", color:"#B8860B", difficulty:1 },
      { id:"B", players:["REGGIE BUSH","MATT LEINART","CARSON PALMER","ANTHONY MUNOZ"], label:"PLAYED COLLEGE FOOTBALL AT USC", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["EARL CAMPBELL","RICKY WILLIAMS","VINCE YOUNG","JAMAAL CHARLES"], label:"PLAYED COLLEGE FOOTBALL AT TEXAS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["CRIS CARTER","EZEKIEL ELLIOTT","ORLANDO PACE","JOEY BOSA"], label:"PLAYED COLLEGE FOOTBALL AT OHIO STATE", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 7, title: "ROUND 7",
  ...
  },
  {
    ...
    groups: [
      { id:"A", players:["TONY GONZALEZ","REGGIE WHITE","PEYTON MANNING","JUNIOR SEAU"], label:"PLAYED IN 10+ NFL PRO BOWLS", color:"#2E6B3E", difficulty:2 },
      { id:"B", players:["JOE MONTANA","JERRY RICE","ROGER CRAIG","CHARLES HALEY"], label:"PLAYED FOR THE SAN FRANCISCO 49ers 1980s DYNASTY", color:"#B8860B", difficulty:1 },
  ...
  },
  {
    ...
    players: ["DEION SANDERS","DERRICK BROOKS","WARRICK DUNN","ANQUAN BOLDIN","EMMITT SMITH","WALTER PAYTON","FRANK GORE","BARRY SANDERS","J.J. WATT","LUKE KUECHLY","KHALIL MACK","AARON DONALD","DESMOND HOWARD","MALCOLM SMITH","LARRY BROWN","OTTIS ANDERSON"],
    groups: [
      ...
      { id:"D", players:["DESMOND HOWARD","MALCOLM SMITH","LARRY BROWN","OTTIS ANDERSON"], label:"WON SUPER BOWL MVP AS A NON-QUARTERBACK", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    ...
    groups: [
      ...
      { id:"B", players:["JOHN ELWAY","JEROME BETTIS","PEYTON MANNING","RAY LEWIS"], label:"WON A SUPER BOWL IN THEIR FINAL NFL SEASON", color:"#8B1A2A", difficulty:4 },
      ...
      { id:"D", players:["TERRY BRADSHAW","FRANCO HARRIS","LYNN SWANN","MEAN JOE GREENE"], label:"PLAYED ON THE PITTSBURGH STEELERS DYNASTY OF THE 1970s", color:"#2E6B3E", difficulty:2 }
    ]
  },
  {
    id: 12, title: "ROUND 12",
    players: ["BRETT FAVRE","AARON RODGERS","BART STARR","LYNN DICKEY","EARL CAMPBELL","WARREN MOON","MIKE MUNCHAK","BRUCE MATTHEWS","MARCUS ALLEN","BO JACKSON","HOWIE LONG","TIM BROWN","JOHNNY UNITAS","LENNY MOORE","RAYMOND BERRY","JOHN MACKEY"],
    groups: [
      { id:"A", players:["BRETT FAVRE","AARON RODGERS","BART STARR","LYNN DICKEY"], label:"PLAYED QUARTERBACK FOR THE GREEN BAY PACKERS", color:"#B8860B", difficulty:1 },
      { id:"B", players:["EARL CAMPBELL","WARREN MOON","MIKE MUNCHAK","BRUCE MATTHEWS"], label:"PLAYED FOR THE HOUSTON OILERS (NOW TENNESSEE TITANS)", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["MARCUS ALLEN","BO JACKSON","HOWIE LONG","TIM BROWN"], label:"PLAYED FOR THE LOS ANGELES / OAKLAND RAIDERS", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["JOHNNY UNITAS","LENNY MOORE","RAYMOND BERRY","JOHN MACKEY"], label:"PLAYED FOR THE BALTIMORE COLTS (NOW INDIANAPOLIS)", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 13, title: "ROUND 13",
    players: ["ADRIAN PETERSON","SAM BRADFORD","BAKER MAYFIELD","KYLER MURRAY","TOM BRADY","GEORGE BLANDA","MORTEN ANDERSEN","ADAM VINATIERI","BRUCE SMITH","REGGIE WHITE","DEION SANDERS","WARREN SAPP","JOE MONTANA","TIM BROWN","JEROME BETTIS","JOE THEISMANN"],
    groups: [
  ...
  },
  {
    ...
    groups: [
      { id:"A", players:["PEYTON MANNING","DAN MARINO","MATTHEW STAFFORD","PHILIP RIVERS"], label:"THREW FOR 4,000+ YARDS IN A SINGLE SEASON", color:"#2E6B3E", difficulty:2 },
      { id:"B", players:["JERRY RICE","LARRY FITZGERALD","TERRELL OWENS","RANDY MOSS"], label:"TOP 5 ALL-TIME IN NFL CAREER RECEIVING YARDS", color:"#B8860B", difficulty:1 },
  ...
  },
  {
    ...
    groups: [
      { id:"A", players:["ERIC DICKERSON","ADRIAN PETERSON","SAQUON BARKLEY","CURTIS MARTIN"], label:"RUSHED FOR 1,300+ YARDS AS A ROOKIE", color:"#2E6B3E", difficulty:2 },
      { id:"B", players:["RAY LEWIS","ED REED","MICHAEL IRVIN","SEAN TAYLOR"], label:"PLAYED COLLEGE FOOTBALL AT \"THE U\" (UNIVERSITY OF MIAMI)", color:"#B8860B", difficulty:1 },
  ...
  },
  {
    ...
    groups: [
      ...
      { id:"C", players:["DESMOND HOWARD","MARCUS ALLEN","JIM PLUNKETT","ROGER STAUBACH"], label:"WON A HEISMAN TROPHY AND A SUPER BOWL MVP", color:"#8B1A2A", difficulty:4 },
      { id:"D", players:["DAVID TYREE","SANTONIO HOLMES","ODELL BECKHAM JR.","DWIGHT CLARK"], label:"FAMOUS FOR ONE ICONIC INDIVIDUAL CATCH", color:"#1B4F8A", difficulty:3 }
    ]
  },
  {
    id: 18, title: "ROUND 18",
    players: ["PATRICK MAHOMES","DONOVAN McNABB","ALEX SMITH","MICHAEL VICK","DREW BLEDSOE","MAC JONES","BERNIE KOSAR","CAM NEWTON","DAN MARINO","BOB GRIESE","EARL MORRALL","DAVID WOODLEY","ROGER STAUBACH","DON MEREDITH","CRAIG MORTON","DANNY WHITE"],
    groups: [
      { id:"A", players:["PATRICK MAHOMES","DONOVAN McNABB","ALEX SMITH","MICHAEL VICK"], label:"PLAYED QUARTERBACK UNDER HEAD COACH ANDY REID", color:"#B8860B", difficulty:1 },
      { id:"B", players:["DREW BLEDSOE","MAC JONES","BERNIE KOSAR","CAM NEWTON"], label:"PLAYED QUARTERBACK UNDER HEAD COACH BILL BELICHICK", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["DAN MARINO","BOB GRIESE","EARL MORRALL","DAVID WOODLEY"], label:"PLAYED QUARTERBACK UNDER HEAD COACH DON SHULA", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["ROGER STAUBACH","DON MEREDITH","CRAIG MORTON","DANNY WHITE"], label:"PLAYED QUARTERBACK UNDER HEAD COACH TOM LANDRY", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
  ...
  },
  {
    ...
    players: ["RAY LEWIS","ED REED","TERRELL SUGGS","HALOTI NGATA","LAMAR JACKSON","COOPER KUPP","JUSTIN JEFFERSON","SAQUON BARKLEY","JIM KELLY","THURMAN THOMAS","BRUCE SMITH","ANDRE REED","TOM BRADY","JOE MONTANA","TERRY BRADSHAW","PATRICK MAHOMES"],
    groups: [
      ...
      { id:"B", players:["LAMAR JACKSON","COOPER KUPP","JUSTIN JEFFERSON","SAQUON BARKLEY"], label:"WON NFL OFFENSIVE PLAYER OF THE YEAR SINCE 2019", color:"#8B1A2A", difficulty:4 },
      ...
      { id:"D", players:["TOM BRADY","JOE MONTANA","TERRY BRADSHAW","PATRICK MAHOMES"], label:"WON SUPER BOWL MVP MULTIPLE TIMES", color:"#2E6B3E", difficulty:2 }
    ]
  },
  {
  ...
  },
  {
    ...
    groups: [
      ...
      { id:"B", players:["LAWRENCE TAYLOR","PATRICK WILLIS","BRIAN URLACHER","KHALIL MACK"], label:"WON AP NFL DEFENSIVE ROOKIE OF THE YEAR", color:"#1B4F8A", difficulty:3 },
      { id:"C", players:["BOB GRIESE","LARRY CSONKA","NICK BUONICONTI","PAUL WARFIELD"], label:"PLAYED ON THE 1972 MIAMI DOLPHINS PERFECT SEASON TEAM", color:"#2E6B3E", difficulty:2 },
  ...
  },
  {
    ...
    players: ["RICHARD SHERMAN","EARL THOMAS","KAM CHANCELLOR","BRANDON BROWNER","MIKE SINGLETARY","RICHARD DENT","DAN HAMPTON","WILLIAM PERRY","MEAN JOE GREENE","JACK HAM","JACK LAMBERT","MEL BLOUNT","CARL ELLER","ALAN PAGE","JIM MARSHALL","GARY LARSEN"],
    groups: [
      { id:"A", players:["RICHARD SHERMAN","EARL THOMAS","KAM CHANCELLOR","BRANDON BROWNER"], label:"THE 2010s SEATTLE SEAHAWKS \"LEGION OF BOOM\" SECONDARY", color:"#B8860B", difficulty:1 },
      { id:"B", players:["MIKE SINGLETARY","RICHARD DENT","DAN HAMPTON","WILLIAM PERRY"], label:"THE 1985 CHICAGO BEARS \"MONSTERS OF THE MIDWAY\" DEFENSE", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["MEAN JOE GREENE","JACK HAM","JACK LAMBERT","MEL BLOUNT"], label:"THE 1970s PITTSBURGH STEELERS \"STEEL CURTAIN\" DEFENSE", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["CARL ELLER","ALAN PAGE","JIM MARSHALL","GARY LARSEN"], label:"THE 1970s MINNESOTA VIKINGS \"PURPLE PEOPLE EATERS\" DEFENSIVE LINE", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 25, title: "ROUND 25",
    players: ["BILL BELICHICK","CHUCK NOLL","BILL WALSH","JOE GIBBS","PETE CARROLL","JIM HARBAUGH","NICK SABAN","STEVE SPURRIER","MARV LEVY","BUD GRANT","DAN REEVES","JOHN FOX","MIKE DITKA","TOM FLORES","DOUG PEDERSON","TOM LANDRY"],
    groups: [
      { id:"A", players:["BILL BELICHICK","CHUCK NOLL","BILL WALSH","JOE GIBBS"], label:"WON 3 OR MORE SUPER BOWLS AS HEAD COACH", color:"#B8860B", difficulty:1 },
      { id:"B", players:["PETE CARROLL","JIM HARBAUGH","NICK SABAN","STEVE SPURRIER"], label:"WAS A HEAD COACH AT BOTH THE COLLEGE AND NFL LEVEL", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["MARV LEVY","BUD GRANT","DAN REEVES","JOHN FOX"], label:"LOST MULTIPLE SUPER BOWLS AS HEAD COACH AND NEVER WON ONE", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["MIKE DITKA","TOM FLORES","DOUG PEDERSON","TOM LANDRY"], label:"NFL PLAYER WHO LATER WON A SUPER BOWL AS HEAD COACH", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 26, title: "ROUND 26",
    players: ["BRAD JOHNSON","MIKE ALSTOTT","DERRICK BROOKS","WARREN SAPP","O.J. SIMPSON","AARON HERNANDEZ","MICHAEL VICK","PLAXICO BURRESS","TIM COUCH","JOHNNY MANZIEL","BRADY QUINN","BAKER MAYFIELD","MATTHEW STAFFORD","DREW BREES","WARREN MOON","PHIL SIMMS"],
    groups: [
      ...
      { id:"D", players:["MATTHEW STAFFORD","DREW BREES","WARREN MOON","PHIL SIMMS"], label:"THREW FOR 500+ YARDS IN A SINGLE NFL GAME", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 27, title: "ROUND 27",
    players: ["JAKE DELHOMME","STEPHEN DAVIS","STEVE SMITH","JULIUS PEPPERS","BRANDON JACOBS","DERRICK HENRY","LATAVIUS MURRAY","EDDIE GEORGE","BO JACKSON","CAM NEWTON","RONNIE BROWN","CADILLAC WILLIAMS","VINCE YOUNG","CARSON PALMER","REGGIE BUSH","DENARD ROBINSON"],
    groups: [
      { id:"A", players:["JAKE DELHOMME","STEPHEN DAVIS","STEVE SMITH","JULIUS PEPPERS"], label:"PLAYED FOR THE CAROLINA PANTHERS SUPER BOWL XXXVIII TEAM", color:"#B8860B", difficulty:1 },
      { id:"B", players:["BRANDON JACOBS","DERRICK HENRY","LATAVIUS MURRAY","EDDIE GEORGE"], label:"LISTED AT 6'1\" OR TALLER AS AN NFL RUNNING BACK", color:"#2E6B3E", difficulty:2 },
      { id:"C", players:["BO JACKSON","CAM NEWTON","RONNIE BROWN","CADILLAC WILLIAMS"], label:"PLAYED COLLEGE FOOTBALL AT AUBURN", color:"#1B4F8A", difficulty:3 },
  ...
  },
  {
    ...
    players: ["DREW BREES","REGGIE BUSH","PIERRE THOMAS","JEREMY SHOCKEY","DARREN SPROLES","DANNY WOODHEAD","MAURICE JONES-DREW","TARIK COHEN","J.J. WATT","RUSSELL WILSON","MELVIN GORDON","JONATHAN TAYLOR","TIM TEBOW","JOHNNY MANZIEL","ERIC CROUCH","ANDRE WARE"],
    groups: [
      { id:"A", players:["DREW BREES","REGGIE BUSH","PIERRE THOMAS","JEREMY SHOCKEY"], label:"PLAYED FOR THE NEW ORLEANS SAINTS SUPER BOWL XLIV TEAM", color:"#B8860B", difficulty:1 },
      ...
      { id:"D", players:["TIM TEBOW","JOHNNY MANZIEL","ERIC CROUCH","ANDRE WARE"], label:"WON THE HEISMAN TROPHY AND IS CONSIDERED AN NFL DRAFT BUST", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 29, title: "ROUND 29",
    players: ["PEYTON MANNING","DEMARCUS WARE","VON MILLER","DEMARYIUS THOMAS","JIM BROWN","BARRY SANDERS","LARRY FITZGERALD","CALVIN JOHNSON","VINNY TESTAVERDE","JOSH McCOWN","RYAN FITZPATRICK","JACOBY BRISSETT","JOE THEISMANN","BO JACKSON","STERLING SHARPE","ROBERT EDWARDS"],
    groups: [
      ...
      { id:"C", players:["VINNY TESTAVERDE","JOSH McCOWN","RYAN FITZPATRICK","JACOBY BRISSETT"], label:"PLAYED QUARTERBACK FOR 4+ DIFFERENT NFL FRANCHISES", color:"#1B4F8A", difficulty:3 },
      { id:"D", players:["JOE THEISMANN","BO JACKSON","STERLING SHARPE","ROBERT EDWARDS"], label:"NFL CAREER ENDED BY A SINGLE DEFINING INJURY", color:"#8B1A2A", difficulty:4 }
    ]
  },
  {
    id: 30, title: "ROUND 30",
    players: ["COLIN KAEPERNICK","FRANK GORE","PATRICK WILLIS","NaVORRO BOWMAN","JIMMY GAROPPOLO","BROCK OSWEILER","STEVE YOUNG","AARON RODGERS","MIKE VRABEL","MIKE SINGLETARY","DAN CAMPBELL","RON RIVERA","JOEY BOSA","J.J. WATT","SHANNON SHARPE","TRAVIS KELCE"],
    groups: [
      { id:"A", players:["COLIN KAEPERNICK","FRANK GORE","PATRICK WILLIS","NaVORRO BOWMAN"], label:"PLAYED FOR THE SAN FRANCISCO 49ERS IN THE 2010s", color:"#B8860B", difficulty:1 },
